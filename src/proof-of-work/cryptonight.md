...
* Хеш CryptoNight относительно сложен для верификации. Это создаёт риск с точки зрения возможности проведения DoS атаки на узлы с использованием недействительных доказательств процесса. См. требование к [строгой асимметрии](ССЫЛКА).
